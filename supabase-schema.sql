-- SafeSpace Database Schema for Supabase
...
CREATE TABLE IF NOT EXISTS users (
  ...
  CONSTRAINT users_display_name_invite_code_key UNIQUE (display_name, invite_code)
);
...
CREATE INDEX IF NOT EXISTS idx_mood_created_at ON mood_logs(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_mood_user_created ON mood_logs(user_id, created_at DESC);
